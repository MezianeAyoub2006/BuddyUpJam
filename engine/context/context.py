...
class GameContext:
    ...
    def set_resolution(self, resolution):
        self.screen = pygame.display.set_mode(resolution, self.flags, vsync=self.vsync)
    ...
    def render_rect(self, rect:pygame.Rect, color:Tuple[int, int, int], z_pos:Union[float, None]=None, alpha=255):
